...
def get_config():
    ...
    parser.add_argument("--MaxMatch", type=int, default=16,
    ...
    parser.add_argument("--spdup_factor", type=int, default=3,
                        help="Pixel jump step for reference blocks (default: 3)")
    parser.add_argument("--WindowSize", type=int, default=39,
    ...
    parser.add_argument("--Transform_Type", type=str, default="3D_DCT", help = "3D Transform type (default = 3D_DCT)\nOptions:\n DCT_Wavelet, Wavelet, 3D_DCT")
    parser.add_argument("--Wavelet_Type", type=str, default="haar", help= "Wavelet type for 3D transform. (default = haar)")
